...
class WorkInventoryFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $sentences = [
            ...
            'Nam at congue nulla.',
            'Sed a sodales leo, fermentum lobortis tellus.',
            'Morbi et risus sed enim consequat auctor id convallis massa.',
            'Duis lacus enim, accumsan eget tristique sed, viverra et augue.',
            'Curabitur ut sodales ante.',
            ...
            'Suspendisse massa arcu, laoreet eget cursus non, vulputate eget diam.',
            'Vestibulum nisl sapien, pellentesque non consectetur et, finibus eget elit.',
            'Phasellus quis tincidunt arcu.',
            'Suspendisse sed lectus dui.',
            'In laoreet libero orci, sed tincidunt sapien viverra eget.',
            ...
            'Nulla facilisi.',
            'Suspendisse ac nisi laoreet, vulputate augue eget, porttitor arcu.',
            'Etiam vel urna ullamcorper, dignissim urna non, consequat ex.',
            'Duis tempor nibh sapien.',
            'Donec pellentesque arcu quis feugiat dapibus.',
            'Sed consequat enim et neque iaculis elementum.',
            'Nulla massa metus, vestibulum ut eros a, feugiat vehicula tortor.',
            'Pellentesque tristique molestie tortor posuere rutrum.',
            'Praesent porttitor magna id ligula congue, a scelerisque ligula fringilla.',
