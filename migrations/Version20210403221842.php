 ...
 */
final class Version20210403221842 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__tariff AS SELECT id, name, price FROM tariff');
        $this->addSql('DROP TABLE tariff');
        $this->addSql('CREATE TABLE tariff (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, price NUMERIC(10, 2) NOT NULL)');
        $this->addSql('INSERT INTO tariff (id, name, price) SELECT id, name, price FROM __temp__tariff');
        $this->addSql('DROP TABLE __temp__tariff');
