 ...
 */
final class Version20210401203802 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__work_inventory AS SELECT id, tarif_id, user_id, invoice_id, company_id, describe, work_start, work_end FROM work_inventory');
        ...
        $this->addSql('INSERT INTO work_inventory (id, tarif_id, user_id, invoice_id, company_id, describe, work_start, work_end) SELECT id, tarif_id, user_id, invoice_id, company_id, describe, work_start, work_end FROM __temp__work_inventory');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__work_inventory AS SELECT id, tarif_id, user_id, invoice_id, company_id, describe, work_start, work_end FROM work_inventory');
        $this->addSql('DROP TABLE work_inventory');
        $this->addSql('CREATE TABLE work_inventory (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, tarif_id INTEGER NOT NULL, user_id INTEGER NOT NULL, invoice_id INTEGER DEFAULT NULL, company_id INTEGER NOT NULL, describe VARCHAR(255) NOT NULL, work_start DATETIME NOT NULL, work_end DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO work_inventory (id, tarif_id, user_id, invoice_id, company_id, describe, work_start, work_end) SELECT id, tarif_id, user_id, invoice_id, company_id, describe, work_start, work_end FROM __temp__work_inventory');
        $this->addSql('DROP TABLE __temp__work_inventory');
        $this->addSql('CREATE INDEX IDX_D325E263357C0A59 ON work_inventory (tarif_id)');
        $this->addSql('CREATE INDEX IDX_D325E263A76ED395 ON work_inventory (user_id)');
