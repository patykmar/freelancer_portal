 ...
 */
final class Version20210401060429 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE company_tariff');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__invoice_item AS SELECT id, invoice_id, name, unit_count, price, discount, margin, vat FROM invoice_item');
        ...
        $this->addSql('INSERT INTO invoice_item (id, invoice_id, name, unit_count, price, discount, margin, vat) SELECT id, invoice_id, name, unit_count, price, discount, margin, vat FROM __temp__invoice_item');
        ...
        $this->addSql('DROP INDEX IDX_D325E263357C0A59');
        $this->addSql('CREATE TEMPORARY TABLE __temp__work_inventory AS SELECT id, tarif_id, user_id, invoice_id, describe, work_start, work_end FROM work_inventory');
        $this->addSql('DROP TABLE work_inventory');
        $this->addSql('CREATE TABLE work_inventory (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, tarif_id INTEGER NOT NULL, user_id INTEGER NOT NULL, invoice_id INTEGER DEFAULT NULL, company_id INTEGER NOT NULL, describe VARCHAR(255) NOT NULL COLLATE BINARY, work_start DATETIME NOT NULL, work_end DATETIME DEFAULT NULL, CONSTRAINT FK_D325E263357C0A59 FOREIGN KEY (tarif_id) REFERENCES tariff (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D325E263A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D325E2632989F1FD FOREIGN KEY (invoice_id) REFERENCES invoice (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D325E263979B1AD6 FOREIGN KEY (company_id) REFERENCES company (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO work_inventory (id, tarif_id, user_id, invoice_id, describe, work_start, work_end) SELECT id, tarif_id, user_id, invoice_id, describe, work_start, work_end FROM __temp__work_inventory');
        ...
        $this->addSql('CREATE INDEX IDX_D325E263357C0A59 ON work_inventory (tarif_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE company_tariff (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, company_id INTEGER NOT NULL, tariff_id INTEGER NOT NULL)');
        $this->addSql('CREATE INDEX IDX_A9FA440892348FD2 ON company_tariff (tariff_id)');
        $this->addSql('CREATE INDEX IDX_A9FA4408979B1AD6 ON company_tariff (company_id)');
        $this->addSql('DROP INDEX IDX_4FBF094FF92F3E70');
        $this->addSql('CREATE TEMPORARY TABLE __temp__company AS SELECT id, country_id, name, description, company_id, vat_number, created, modify, street, city, zip_code, account_number, iban FROM company');
        $this->addSql('DROP TABLE company');
        ...
        $this->addSql('CREATE INDEX IDX_90651744A76ED395 ON invoice (user_id)');
        $this->addSql('DROP INDEX IDX_1DDE477B2989F1FD');
        $this->addSql('CREATE TEMPORARY TABLE __temp__invoice_item AS SELECT id, invoice_id, vat, name, unit_count, price, discount, margin FROM invoice_item');
        $this->addSql('DROP TABLE invoice_item');
        $this->addSql('CREATE TABLE invoice_item (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, invoice_id INTEGER NOT NULL, vat SMALLINT NOT NULL, name VARCHAR(255) NOT NULL, unit_count SMALLINT NOT NULL, price NUMERIC(10, 2) NOT NULL, discount SMALLINT NOT NULL, margin SMALLINT DEFAULT NULL)');
        $this->addSql('INSERT INTO invoice_item (id, invoice_id, vat, name, unit_count, price, discount, margin) SELECT id, invoice_id, vat, name, unit_count, price, discount, margin FROM __temp__invoice_item');
        $this->addSql('DROP TABLE __temp__invoice_item');
        $this->addSql('CREATE INDEX IDX_1DDE477B2989F1FD ON invoice_item (invoice_id)');
        $this->addSql('DROP INDEX IDX_D325E263357C0A59');
        $this->addSql('DROP INDEX IDX_D325E263A76ED395');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__work_inventory AS SELECT id, tarif_id, user_id, invoice_id, describe, work_start, work_end FROM work_inventory');
        $this->addSql('DROP TABLE work_inventory');
        $this->addSql('CREATE TABLE work_inventory (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, tarif_id INTEGER NOT NULL, user_id INTEGER NOT NULL, invoice_id INTEGER DEFAULT NULL, describe VARCHAR(255) NOT NULL, work_start DATETIME NOT NULL, work_end DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO work_inventory (id, tarif_id, user_id, invoice_id, describe, work_start, work_end) SELECT id, tarif_id, user_id, invoice_id, describe, work_start, work_end FROM __temp__work_inventory');
        $this->addSql('DROP TABLE __temp__work_inventory');
        $this->addSql('CREATE INDEX IDX_D325E263357C0A59 ON work_inventory (tarif_id)');
        $this->addSql('CREATE INDEX IDX_D325E263A76ED395 ON work_inventory (user_id)');
