 ...
 */
final class Version20210403225422 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO work_inventory (id, tariff_id, user_id, invoice_id, company_id, describe, work_start, work_end, work_duration) SELECT id, tarif_id, user_id, invoice_id, company_id, describe, work_start, work_end, work_duration FROM __temp__work_inventory');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE work_inventory');
        $this->addSql('CREATE TABLE work_inventory (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, invoice_id INTEGER DEFAULT NULL, company_id INTEGER NOT NULL, describe VARCHAR(255) NOT NULL, work_start DATETIME NOT NULL, work_end DATETIME DEFAULT NULL, work_duration DOUBLE PRECISION DEFAULT NULL, tarif_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO work_inventory (id, tarif_id, user_id, invoice_id, company_id, describe, work_start, work_end, work_duration) SELECT id, tariff_id, user_id, invoice_id, company_id, describe, work_start, work_end, work_duration FROM __temp__work_inventory');
        $this->addSql('DROP TABLE __temp__work_inventory');
        $this->addSql('CREATE INDEX IDX_D325E263A76ED395 ON work_inventory (user_id)');
        $this->addSql('CREATE INDEX IDX_D325E2632989F1FD ON work_inventory (invoice_id)');
        $this->addSql('CREATE INDEX IDX_D325E263979B1AD6 ON work_inventory (company_id)');
