 ...
 */
final class Version20210404213224 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__company AS SELECT id, country_id, name, description, company_id, vat_number, created, modify, street, city, zip_code, account_number, iban, is_supplier FROM company');
        $this->addSql('DROP TABLE company');
        $this->addSql('CREATE TABLE company (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, country_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, company_id VARCHAR(50) DEFAULT NULL COLLATE BINARY, vat_number VARCHAR(50) DEFAULT NULL COLLATE BINARY, created DATETIME NOT NULL, modify DATETIME DEFAULT NULL, street VARCHAR(255) DEFAULT NULL COLLATE BINARY, city VARCHAR(255) DEFAULT NULL COLLATE BINARY, zip_code VARCHAR(20) DEFAULT NULL COLLATE BINARY, account_number VARCHAR(255) DEFAULT NULL COLLATE BINARY, iban VARCHAR(255) DEFAULT NULL COLLATE BINARY, is_supplier BOOLEAN DEFAULT NULL, CONSTRAINT FK_4FBF094FF92F3E70 FOREIGN KEY (country_id) REFERENCES country (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO company (id, country_id, name, description, company_id, vat_number, created, modify, street, city, zip_code, account_number, iban, is_supplier) SELECT id, country_id, name, description, company_id, vat_number, created, modify, street, city, zip_code, account_number, iban, is_supplier FROM __temp__company');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__invoice AS SELECT id, supplier_id, subscriber_id, payment_type_id, user_id, due, invoice_created, due_date, payment_day, ks, vs FROM invoice');
        $this->addSql('DROP TABLE invoice');
        $this->addSql('CREATE TABLE invoice (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, supplier_id INTEGER NOT NULL, subscriber_id INTEGER NOT NULL, payment_type_id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, due SMALLINT NOT NULL, invoice_created DATETIME NOT NULL, due_date DATE NOT NULL, payment_day DATE DEFAULT NULL, ks VARCHAR(20) DEFAULT NULL COLLATE BINARY, vs VARCHAR(20) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_906517442ADD6D8C FOREIGN KEY (supplier_id) REFERENCES company (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_906517447808B1AD FOREIGN KEY (subscriber_id) REFERENCES company (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_90651744DC058279 FOREIGN KEY (payment_type_id) REFERENCES payment_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_90651744A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO invoice (id, supplier_id, subscriber_id, payment_type_id, user_id, due, invoice_created, due_date, payment_day, ks, vs) SELECT id, supplier_id, subscriber_id, payment_type_id, user_id, due, invoice_created, due_date, payment_day, ks, vs FROM __temp__invoice');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__invoice_item AS SELECT id, invoice_id, name, price, discount, margin, vat, discount_total, margin_total, price_total, price_total_inc_vat, unit_count FROM invoice_item');
        $this->addSql('DROP TABLE invoice_item');
        $this->addSql('CREATE TABLE invoice_item (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, invoice_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, price NUMERIC(10, 2) NOT NULL, discount SMALLINT NOT NULL, margin SMALLINT DEFAULT NULL, vat SMALLINT NOT NULL, discount_total NUMERIC(10, 2) NOT NULL, margin_total NUMERIC(10, 2) NOT NULL, price_total NUMERIC(10, 2) NOT NULL, price_total_inc_vat NUMERIC(10, 2) NOT NULL, unit_count DOUBLE PRECISION NOT NULL, CONSTRAINT FK_1DDE477B2989F1FD FOREIGN KEY (invoice_id) REFERENCES invoice (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO invoice_item (id, invoice_id, name, price, discount, margin, vat, discount_total, margin_total, price_total, price_total_inc_vat, unit_count) SELECT id, invoice_id, name, price, discount, margin, vat, discount_total, margin_total, price_total, price_total_inc_vat, unit_count FROM __temp__invoice_item');
        $this->addSql('DROP TABLE __temp__invoice_item');
        $this->addSql('CREATE INDEX IDX_1DDE477B2989F1FD ON invoice_item (invoice_id)');
        $this->addSql('ALTER TABLE payment_type ADD COLUMN is_default BOOLEAN DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__invoice_item');
        $this->addSql('CREATE INDEX IDX_1DDE477B2989F1FD ON invoice_item (invoice_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__payment_type AS SELECT id, name FROM payment_type');
        ...
        $this->addSql('INSERT INTO payment_type (id, name) SELECT id, name FROM __temp__payment_type');
        $this->addSql('DROP TABLE __temp__payment_type');
        $this->addSql('DROP INDEX IDX_D325E26392348FD2');
        $this->addSql('DROP INDEX IDX_D325E263A76ED395');
        $this->addSql('DROP INDEX IDX_D325E2632989F1FD');
        $this->addSql('DROP INDEX IDX_D325E263979B1AD6');
